...
description: >
  ...
  openEHR Assistant MCP server. Covers authoring new implementation guides (resources/guides/) and
  MCP prompt files (resources/prompts/ + src/Prompts/) in the openehr-assistant-mcp repository.
